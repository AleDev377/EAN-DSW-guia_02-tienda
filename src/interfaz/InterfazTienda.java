...
public class InterfazTienda extends JFrame {
    ...
    public void mostrarDineroEnCaja() {
        double dineroEnCaja = tienda.darDineroEnCaja();
        String mensaje = String.format("En caja hay: %.2f $", dineroEnCaja);
        JOptionPane.showMessageDialog(this, mensaje, "Dinero en caja", JOptionPane.INFORMATION_MESSAGE);
    ...
    public void mostrarPromedioVentas() {
        double promedioVentas = tienda.darPromedioVentas();
        String mensaje = String.format("El promedio de ventas es: %.2f", promedioVentas);
        JOptionPane.showMessageDialog(this, mensaje, "Promedio ventas", JOptionPane.INFORMATION_MESSAGE);
    }
