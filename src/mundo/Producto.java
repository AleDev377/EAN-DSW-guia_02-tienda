...
public class Producto {
     ...
     * <b> post: </b> El tipo, nombre, valor unitario, cantidad en bodega,
     * cantidad mínima y ruta imagen fueron inicializados con los valores dado por parámetro.
     *
     ...
     */
    public Producto(String pTipo, String pNombre, double pValorUnitario, int pCantidadBodega,
                    int pCantidadMinima, String pRutaImagen) {
    ...
    public double calcularPrecioFinal() {
        ...
        return (this.valorUnitario + this.valorUnitario * darIVA() );
    }
    ...
    public int vender(int pCantidad) {
        ...
        this.cantidadUnidadesVendidas +=cantidadVendida;
